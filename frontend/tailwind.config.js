            ...
            function ({addBase}) {
                addBase({
                    ...
                    "html[data-theme*='dark']": {
                        "--theme-primary": toRgb(colors.gray[800]),
                        "--theme-primary-hover": toRgb(colors.gray[700]),
                        "--theme-secondary": toRgb(colors.gray[700]),
                        "--theme-secondary-hover": toRgb(colors.gray[600]),
