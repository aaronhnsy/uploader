...
import { CreateUploadForm } from "@/components/uploads/createUploadForm";
...
export function CreateUploadButton() {
    ...
    return (
        <>
            <button type="button" aria-label="show create upload form" aria-pressed={uploadFormVisible}
                    className={clsx(
            ...
            {uploadFormVisible && <CreateUploadForm/>}
        </>
    );
}
